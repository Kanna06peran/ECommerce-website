        ...
        <div>
            ...
            <div className='flex items-center justify-center'>
                <div className="w-full sm:w-1/2 flex-col justify-center">
                    ...
                    <img src className='w-60 block sm:hidden' alt="Blog Profile Image" />
                ...
                <div className='justify-center hidden sm:block'>
                    <img src className='w-60 md:w-96 ' alt="Blog Profile Image" />
            ...
            <div>
                ...
                <div className='flex justify-around my-5 flex-col sm:flex-row'>
                    ...
                    <img src className='w-64 border rounded-md cursor-pointer' alt="" />
